...
export function elemInfo(inputID) {
  ...
  getData(`${urlSingle}${inputID}`)
    .then((response) => {
      ...
      getData(`${urlSingle}${inputID}/seasons`)
        .then((response) => {
      ...
      getData(`${urlSingle}${inputID}/cast`)
        .then((response) => {
          if (!response || response.length == 0) {
      ...
      getData(`${urlSingle}${inputID}/crew`)
        .then((response) => {
          if (!response || response.length == 0) {
      ...
      getData(`${urlSingle}${inputID}/akas`)
        .then((response) => {
          if (!response || response.length == 0) {
      ...
      getData(`${urlSingle}${inputID}/episodes`)
        .then((response) => {
          if (!response || response.length == 0) {
            $("#pageInfo").append(
